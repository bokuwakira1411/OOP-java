...
public class Piece {
    ...
    public Piece(TPoint[] points) {
        TPoint[] newPoints = new TPoint[size];
        int maxX = 0, maxY = 0;
        for(int i = 0; i < size; i++){
            newPoints[i] = new TPoint(points[i]);
    ...
    public boolean equals(Object obj) {
        ...
        for(int i = 0; i < size; i++){
                if(this.body[i].x != other.body[i].x){
                    return false;
                }
                if(this.body[i].y != other.body[i].y){
                    return false;
                }
        }
        return true;
