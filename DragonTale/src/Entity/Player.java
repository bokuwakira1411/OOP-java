...
public class Player extends MapObject{
    ...
    public Player(TileMap tm) {
        ...
        //load sprites
        try {
            BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/image/Sprites/Player/Playersprites.gif"));
...
//        }
    ...
    public void update(){
        ...
        if(flinching){
            long elapsed = (System.nanoTime() - flichTimer) / 1000000;
            if(elapsed > 1000){
                flinching = false;
            }
        }
